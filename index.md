...
Completing the computer science program has helped me develop my understanding of the field while helping me identify the areas that match my preferences, strengths and goals. In the program, I gained experience with programming, data analysis, databases, security, and technical communication. My interest has always been in data and analysis and the courses in this program reinforced that. Developing the ePortfolio gave me an opportunity to review work from my time at SNHU and see how I am better equipped to improve previous work. Together, these experiences have prepared me to enter the computer science field by giving me both technical experience and understanding.
	Finishing this program in an online setting was challenging, but it gave me experience in communicating with peers and instructors through digital platforms. Compared with a traditional program, interacting with professors through assignments and email and with classmates through discussion posts and other online spaces helped prepare me for more distributed and long-distance work environments that are increasingly common today especially in computer science environments. These experiences strengthened my ability to communicate clearly without in person interaction.
	The classes I completed gave me experience across many areas of computer science, from basic mathematics and algorithms to full-stack and application development. Java, Python, SQL, C, and HTML were all used extensively in different ways throughout the program. In classes such as DAT 260: Emerging Technologies and Big Data, I learned about new developments in data analysis technology that I will likely encounter in my career. CS 320: Software Testing, Automation, and Quality Assurance exposed me to application testing, while CS 305: Software Security introduced me to methods for developing more secure applications. CS 340: Client/Server Development also gave me experience building applications that interact with databases. Together, these courses helped prepare me to create robust data solutions for problems I may encounter in my career.
	This program also helped me better identify my strengths and professional goals. I found that I am most interested in work involving data analysis, problem solving, and using software to turn large amounts of real world information into physical results. The variety of coursework helped me see how programming, databases, algorithms, and software development can all support that goal. Developing the ePortfolio gave me an opportunity to look back at projects from earlier in the program and improve them using skills I developed later. This process shows growth as a computer science student.
...
[Original](https://github.com/BriaKll/CS499/blob/main/CS330Original.zip)

[Revised](https://github.com/BriaKll/CS499/blob/main/CS330Revised.zip)

[Narrative](https://github.com/BriaKll/CS499/blob/main/Narrative1.docx)
## Narrative 1	
...
[Original](https://github.com/BriaKll/CS499/tree/main/CS340%20Original)

[Revised](https://github.com/BriaKll/CS499/tree/main/CS340%20Revised)

[Narrative](https://github.com/BriaKll/CS499/blob/main/Narrative2.docx)
## Narrative 2
Briefly describe the artifact. What is it? When was it created?
...
[Narrative](https://github.com/BriaKll/CS499/blob/main/Narrative3.docx)
## Narrative 3
Briefly describe the artifact. What is it? When was it created?
